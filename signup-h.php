...
if($_POST){
    ...
    if ($newpassword==$cpassword){
        ...
        if($result->num_rows==1){
            ...
            $database->query("insert into pharmacist(phremail,phrname,phrpassword,phrnic,phrtel) values('$email','$name','$newpassword','$nic','$tele');");
            $database->query("insert into webuser values('$email','h')");

            //print_r("insert into pharmacist values($pid,'$email','$fname','$lname','$newpassword','$address','$nic','$dob','$tele');");
            $_SESSION["user"]=$email;
            $_SESSION["usertype"]="h";
