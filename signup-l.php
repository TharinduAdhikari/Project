...
<head>
    ...
    <title>Create Lab Assistant Account</title>
    <style>
        .container{
...
if($_POST){
    ...
    if ($newpassword==$cpassword){
        ...
        if($result->num_rows==1){
            ...
            $database->query("insert into labassistant(labemail,labname,labpassword,labnic,labtel) values('$email','$name','$newpassword','$nic','$tele');");
            $database->query("insert into webuser values('$email','l')");

            //print_r("insert into labassistant values($pid,'$email','$fname','$lname','$newpassword','$address','$nic','$dob','$tele');");
            //$_SESSION["user"]=$email;
            //$_SESSION["usertype"]="l";
