...
if($_POST){
    ...
    if ($newpassword==$cpassword){
        ...
        if($result->num_rows==1){
            ...
            $database->query("insert into doctor(docemail,docname,docpassword,docnic,doctel) values('$email','$name','$newpassword','$nic','$tele');");
            $database->query("insert into webuser values('$email','d')");

            //print_r("insert into doctor values($pid,'$email','$fname','$lname','$newpassword','$address','$nic','$dob','$tele');");
            $_SESSION["user"]=$email;
            $_SESSION["usertype"]="d";
