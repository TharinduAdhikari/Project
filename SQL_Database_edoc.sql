...
CREATE TABLE IF NOT EXISTS `pharmacist` (
  ...
  `phremail` varchar(255) DEFAULT NULL,
  `phrname` varchar(255) DEFAULT NULL,
  `phrpassword` varchar(255) DEFAULT NULL,
  `phrnic` varchar(15) DEFAULT NULL,
  `phrtel` varchar(15) DEFAULT NULL,
  PRIMARY KEY (`phrid`)
) ENGINE=MyISAM AUTO_INCREMENT=2 DEFAULT CHARSET=latin1;
...
INSERT INTO `pharmacist` (`phrid`, `phremail`, `phrname`, `phrpassword`, `phrnic`, `phrtel`) VALUES
(1, 'phr@edoc.com', 'Test phr', '123', '000000000', '0110000000');
...
CREATE TABLE IF NOT EXISTS `labassistant` (
  ...
  `labpassword` varchar(255) DEFAULT NULL,
  `labnic` varchar(15) DEFAULT NULL,
  `labtel` varchar(15) DEFAULT NULL,
  PRIMARY KEY (`labid`)
) ENGINE=MyISAM AUTO_INCREMENT=3 DEFAULT CHARSET=latin1;
...
INSERT INTO `labassistant` (`labid`, `labemail`, `labname`, `labpassword`, `labnic`, `labtel`) VALUES
(45, 'lab@edoc.com', 'Test lab', '123', '000000000', '0110000000');